 ...
 * 添加图文
 */
public class AddNewPhotoWordActivity extends BaseActivity {
    ...
    protected void initUI() {
        ...
        FullyGridLayoutManager manager = new FullyGridLayoutManager(AddNewPhotoWordActivity.this, 4, GridLayoutManager.VERTICAL, false);
